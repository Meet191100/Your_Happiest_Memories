...
<center><h2 class="text-center text-success "style="font-family: allura; font-size:35px; margin-top: 0px;">Welcome <?php echo $_SESSION['username']; ?></h2></center>
      ...
      <div class="l-wrapper">
        ...
        <nav class="l-side-nav">
          ...
          <ul class="side-nav">
            ...
            <li><span><a href="http://localhost/login/memories/memory.php" target="meet" style="text-decoration: none; color: white; font-weight:lighter;">My Memories &nbsp&nbsp(Press Here)</a></span></li>
